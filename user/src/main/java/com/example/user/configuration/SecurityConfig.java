...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/users/byHebergement/**").permitAll() // Permet l'accès sans authentification pour cette route
                        .requestMatchers("/users/{userId}/assign/{hebergementId}").permitAll()
                        ...
                        .requestMatchers(
                                ...
                                "/users/user/{id}/role",
                                "/users/byTeam/{teamId}",
                                "/Constructify/users/{id}/role",
                                "/users/removeFromTeam/{userId}",
                                "/users/session",
                                "/users/logout",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:4200")); // Autorise les origines spécifiques
